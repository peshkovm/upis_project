...
public class ApiUtilsOld {
  ...
  public static class AlphaVantageParser {
    ...
    public static void parseStockTimeSeries() {
      ...
      try {
        ...
        do {
          ...
          if (frequencyExcessHandler(node)) return;

          final String refreshed = node.path("Meta Data").get("3. Last Refreshed").asText();
        ...
        Iterator<Map.Entry<String, JsonNode>> fields =
            getFields(node, "Time Series (" + interval + ")");
    ...
    /** Parse Digital & Crypto Currencies with CURRENCY_EXCHANGE_RATE temporal resolution. */
      ...
      try {
        ...
        do {
          ...
          final String refreshed =
              node.path("Realtime Currency Exchange Rate").get("6. Last Refreshed").asText();
        ...
        Iterator<Map.Entry<String, JsonNode>> fields =
            getFields(node, "Realtime Currency Exchange Rate");
